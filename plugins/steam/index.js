...
class SteamPlugin {
    ...
    async fetchDetailsSingle(retreival_data) {
        ...
        const parsed_storyline = parse5.parseFragment(details.about_the_game);
        ...
        clean_nodes(parsed_storyline);
        const cleaned_storyline = parse5.serialize(parsed_storyline);
